...
import com.aladziviesoft.kegiatandakwahfkl.Menabung.Adapter.AdapterTerlaksana;
...
public class TerlaksanaFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_terlaksana_fragment, container, false);
        ...
        stringRequest = new StringRequest(Request.Method.POST, URL_LIST_MENABUNG, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    adapter = new AdapterTerlaksana(arrayList, mActivity);
