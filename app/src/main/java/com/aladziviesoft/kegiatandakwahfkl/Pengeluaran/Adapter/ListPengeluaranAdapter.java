package com.aladziviesoft.kegiatandakwahfkl.Pengeluaran.Adapter;
...
public class ListPengeluaranAdapter extends RecyclerView.Adapter<ListPengeluaranAdapter.PengeluaranHolder> {
    ...
    private ArrayList<ListPengeluaranModel> arrayList;
    private RequestQueue requestQueue;

    public ListPengeluaranAdapter(Context context, ArrayList<ListPengeluaranModel> arrayList) {
    ...
    @NonNull
    @Override
    public PengeluaranHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PengeluaranHolder holder, final int i) {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            switch (which) {
                                case 0:
                                    ...
                                    // set title dialog
                                    alertDialogBuilder.setTitle("Yakin ingin menghapus keperluan : " + arrayList.get(i).getKeperluan() + " ?");
    ...
    private void Delete(final String id_data, final String nominal) {
        ...
        pDialog.show();
        StringRequest strReq = new StringRequest(Request.Method.POST, URL_DELETE_PENGELUARAN, new Response.Listener<String>() {
    ...
    public class PengeluaranHolder extends RecyclerView.ViewHolder {
