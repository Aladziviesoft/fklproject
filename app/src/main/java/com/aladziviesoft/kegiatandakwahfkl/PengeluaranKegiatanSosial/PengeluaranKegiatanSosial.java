...
import com.aladziviesoft.kegiatandakwahfkl.PengeluaranKegiatanSosial.Adapter.AdapterPengeluaranKegiatanSosial;
...
public class PengeluaranKegiatanSosial extends AppCompatActivity {
    ...
    private ArrayList<ModelPengeluaranKegiatanSosial> arrayList = new ArrayList<>();
    ModelPengeluaranKegiatanSosial model;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pengeluaran_kegiatan_sosial);
        ButterKnife.bind(this);
        recListPengeluaran.setHasFixedSize(true);

        sessionManager = new SessionManager(PengeluaranKegiatanSosial.this);
        pDialog = new OwnProgressDialog(PengeluaranKegiatanSosial.this);
        requestQueue = Volley.newRequestQueue(PengeluaranKegiatanSosial.this);
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(PengeluaranKegiatanSosial.this, 1,
        ...
        stringRequest = new StringRequest(Request.Method.POST, URL_LIST_OUT, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int a = 0; a < jsonArray.length(); a++) {
                        JSONObject json = jsonArray.getJSONObject(a);
                        ModelPengeluaranKegiatanSosial modelMenu = new ModelPengeluaranKegiatanSosial();
                    ...
                    AdapterPengeluaranKegiatanSosial adapter = new AdapterPengeluaranKegiatanSosial(PengeluaranKegiatanSosial.this, arrayList);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.floatingActionButton:
                Intent intent = new Intent(PengeluaranKegiatanSosial.this, TambahPengeluaranKegiatanSosial.class);
