package com.aladziviesoft.kegiatandakwahfkl.PemasukanKegiatanSosial;
...
import com.aladziviesoft.kegiatandakwahfkl.PemasukanKegiatanSosial.Adapter.AdapterPemasukanKegiatanSosial;
...
public class PemasukanKegiatanSosial extends AppCompatActivity {
    ...
    List<ModelPemasukanKegiatanSosial> arrayList = new ArrayList<>();
    ModelPemasukanKegiatanSosial model;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pemasukan_kegiatan_sosial);
        ButterKnife.bind(this);
        recListTaawun.setHasFixedSize(true);

        sessionManager = new SessionManager(PemasukanKegiatanSosial.this);
        requestQueue = Volley.newRequestQueue(PemasukanKegiatanSosial.this);
        loading = new OwnProgressDialog(PemasukanKegiatanSosial.this);
...
//        BigDecimal decimal = new BigDecimal(uangkegd.replace(".",""));
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(PemasukanKegiatanSosial.this, 1,
        ...
        stringRequest = new StringRequest(Request.Method.POST, URL_LIST_TAAWUN, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int a = 0; a < jsonArray.length(); a++) {
                        JSONObject json = jsonArray.getJSONObject(a);
                        ModelPemasukanKegiatanSosial modelMenu = new ModelPemasukanKegiatanSosial();
                    ...
                    AdapterPemasukanKegiatanSosial adapter = new AdapterPemasukanKegiatanSosial(arrayList, PemasukanKegiatanSosial.this);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.floatingActionButton:
                Intent a = new Intent(getApplicationContext(), TambahPemasukanKegiatanSosial.class);
