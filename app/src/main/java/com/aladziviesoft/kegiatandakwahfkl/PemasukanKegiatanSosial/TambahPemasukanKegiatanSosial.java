...
import static com.aladziviesoft.kegiatandakwahfkl.utils.AppConf.URL_ADD_SOSIAL;
...
public class TambahPemasukanKegiatanSosial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_pemasukan_kegiatan_sosial);
        ButterKnife.bind(this);
        cekInternet();

        sessionManager = new SessionManager(TambahPemasukanKegiatanSosial.this);
        pDialog = new OwnProgressDialog(TambahPemasukanKegiatanSosial.this);
        requestQueue = Volley.newRequestQueue(TambahPemasukanKegiatanSosial.this);
...
//                DecimalsFormat.priceWithoutDecimal(txSaldo.getText().toString());
    ...
    private void SimpanData() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, URL_ADD_SOSIAL, new Response.Listener<String>() {

            @Override
            public void onResponse(String response) {
                AndLog.ShowLog("ress", response);

                GlobalToast.ShowToast(TambahPemasukanKegiatanSosial.this, "Taawun berhasil ditambahkan");
    ...
    private void UpdateDataTaawun() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, URL_EDIT_TAAWUN, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                GlobalToast.ShowToast(TambahPemasukanKegiatanSosial.this, "Kegiatan berhasil dirubah");
                pDialog.dismiss();
                finish();
